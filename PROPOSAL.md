...
- Keep dictionary words readable; use casing, separators, and an optional random numeric suffix to meet policy requirements.
...
- Apply light optional substitutions in configured mode and one randomized uppercase position when mixed case is required.
